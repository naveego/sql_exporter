...
const (
	docsUrl   = "https://github.com/naveego/data_exporter#readme"
	templates = `
    {{ define "page" -}}
      <html>
      <head>
...
func ConfigHandlerFunc(metricsPath string, exporter data_exporter.Exporter) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
